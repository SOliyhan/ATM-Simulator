...
public class BalanceEnquiry extends JFrame implements ActionListener {
       ...
       public BalanceEnquiry(int atno1,int acno1,int pno1,String actype1)
    {
		...
		l7=new JLabel("Thank You For Banking With Apna BANK. For more information,");
		l7.setFont(f);
		l7.setForeground(Color.RED);
		l7.setBounds(50,450,650,20);jf.add(l7);

		l8=new JLabel("Please call Toll Free No:1800 2000 1911  or  Visit our nearest branch. ");
		l8.setFont(f);
		l8.setForeground(Color.RED);
		l8.setBounds(50,480,650,30);jf.add(l8);

		b1=new JButton("Cancel",new ImageIcon("C:\\Users\\Computer_Ji\\Desktop\\ATM\\cancel.png"));
		b1.setFont(f);
