    ...
    public CashWithdrawal(int atno1,int acno1,int pno1,String actype1)
     {
		...
		b1=new JButton("Enter",new ImageIcon("C:\\Users\\Computer_Ji\\Desktop\\ATM\\ok.png"));
		b1.setFont(f);
		b1.setBounds(120,550,130,40);jf.add(b1);
		b1.addActionListener(this);

		b2=new JButton("Clear",new ImageIcon("C:\\Users\\Computer_Ji\\Desktop\\ATM\\clear.png"));
		b2.setFont(f);
		b2.setBounds(280,550,130,40);jf.add(b2);
		b2.addActionListener(this);

		b3=new JButton("Cancel",new ImageIcon("C:\\Users\\Computer_Ji\\Desktop\\ATM\\cancel.png"));
		b3.setFont(f);
...
JOptionPane.showMessageDialog(this,"Your balance is less,You should keep minimum balance 1000 RS","Warning",JOptionPane.WARNING_MESSAGE);
	      ...
	      {
	 JOptionPane.showMessageDialog(this,"You can not withdraw per day greater than 50000 RS","Warning",JOptionPane.WARNING_MESSAGE);
	       sound.play();
	       t1.setText("");//
	      }
	      }
