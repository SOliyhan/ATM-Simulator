    ...
    AudioClip sound;
      //Timer t;
		...
		Help()
		{
			...
			l9=new JLabel("Developed by: Shivanshu Oliyhan");
			l9.setFont(f);
			l9.setForeground(Color.RED);
			l9.setBounds(40,480,300,25);
			jf.add(l9);

			l10=new JLabel(" and team.");
			l10.setFont(f);
			...
			l12=new JLabel("Mr. Agam Goyal.");
			l12.setFont(f1);
			l12.setForeground(Color.RED);
			l12.setBounds(250,510,250,30);
			jf.add(l12);

			cancel=new JButton("Cancel",new ImageIcon("C:\\Users\\Computer_Ji\\Desktop\\ATM\\cancel.png"));
			cancel.setFont(f);
			cancel.setBounds(280,570,130,40);
			cancel.addActionListener(this);
			jf.add(cancel);

			img=new ImageIcon("C:\\Users\\Computer_Ji\\Desktop\\ATM\\bank.jpg");
	    	l1=new JLabel(img);
